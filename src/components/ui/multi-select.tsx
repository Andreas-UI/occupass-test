...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 py-1 px-3 shadow-xs outline-none bg-transparent border border-input rounded-md ring-1 ring-muted min-w-0 w-full min-h-9",
        {
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "bg-transparent outline-none placeholder:text-muted-foreground flex-1 min-w-0 w-full text-base",
        className,
