    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex items-center flex-wrap gap-1 py-1 px-3 shadow-xs outline-none bg-transparent overflow-hidden border border-input rounded-md min-w-0 w-full min-h-9",
            {
        ...
        >
          ...
          <Input
            ...
            className={cn(
              "shadow-none outline-0 border-none h-7 min-w-fit flex-1 focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0 placeholder:text-muted-foreground px-1",
